...
@Service
public class NotifyEdtiorAndShowCommentsService implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		String odgovor = (String)execution.getVariable("odgovor");

		// poslati mejl autoru rada
		// TODO: skini komentar
		sendEmail(userMail, paper.getName(), comments, odgovor, executionId);
	 ...
	 */
	private void sendEmail(String userMail, String paperName, Set<String> comments, String odgovor, String executionId)
...
//		String userMail = author.getEmail();
		...
		String subject = "Pristigao izmenjen rad";
		String message = "<html><body>Rad <b>" + paperName + "</b> "
				+ " je promenjen. Potrebno ga je ponovo pregledati. <br>Komentari od recenzenata: <i>" + comments
				+ "</i><br> Odgovor autora: <i>" + odgovor + "</i> </body></html>";
