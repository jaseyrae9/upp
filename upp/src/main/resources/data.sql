...
INSERT INTO users(type, id, confirmed_mail, email, first_name, last_name, password, username, accepted_as_reviewer, active, city, country, title, wants_to_be_reviewer, journal_id) 
SELECT 'customer', 1000, true, 'urednik@camunda.org', 'Urednik', 'Urednik', '$2a$10$Zp/LQilwI4szts.Yc5xBSehHCwICvmxeCOxwbhwSfE5vxAUFvflXO', 'urednik', false, true, 'grad', 'drzava', 'title', false, null
WHERE 
NOT EXISTS (
...
INSERT INTO users(type, id, confirmed_mail, email, first_name, last_name, password, username, accepted_as_reviewer, active, city, country, title, wants_to_be_reviewer, journal_id) 
SELECT 'customer', 1001, true, 'urednik1@camunda.org', 'urednik1', 'urednik1', '$2a$10$Zp/LQilwI4szts.Yc5xBSehHCwICvmxeCOxwbhwSfE5vxAUFvflXO', 'urednik1', false, true, 'grad', 'drzava', 'title', false, null
WHERE 
NOT EXISTS (
...
INSERT INTO users(type, id, confirmed_mail, email, first_name, last_name, password, username, accepted_as_reviewer, active, city, country, title, wants_to_be_reviewer, journal_id) 
SELECT 'customer', 1002, true, 'urednik2@camunda.org', 'urednik2', 'urednik2', '$2a$10$Zp/LQilwI4szts.Yc5xBSehHCwICvmxeCOxwbhwSfE5vxAUFvflXO', 'urednik2', false, true, 'grad', 'drzava', 'title', false, null
WHERE 
NOT EXISTS (
...
INSERT INTO users(type, id, confirmed_mail, email, first_name, last_name, password, username, accepted_as_reviewer, active, city, country, title, wants_to_be_reviewer, journal_id) 
SELECT 'customer', 1003, true, 'urednik3@camunda.org', 'Urednik3', 'Urednik3', '$2a$10$Zp/LQilwI4szts.Yc5xBSehHCwICvmxeCOxwbhwSfE5vxAUFvflXO', 'urednik3', false, true, 'grad', 'drzava', 'title', false, null
WHERE 
NOT EXISTS (
...
INSERT INTO users(type, id, confirmed_mail, email, first_name, last_name, password, username, accepted_as_reviewer, active, city, country, title, wants_to_be_reviewer, journal_id) 
SELECT 'customer', 2000, true, 'recenzent@camunda.org', 'recenzent', 'recenzent', '$2a$10$Zp/LQilwI4szts.Yc5xBSehHCwICvmxeCOxwbhwSfE5vxAUFvflXO', 'recenzent', true, true, 'grad', 'drzava', 'title', false, null
WHERE 
NOT EXISTS (
...
INSERT INTO users(type, id, confirmed_mail, email, first_name, last_name, password, username, accepted_as_reviewer, active, city, country, title, wants_to_be_reviewer, journal_id) 
SELECT 'customer', 2001, true, 'recenzent1@camunda.org', 'recenzent1', 'recenzent1', '$2a$10$Zp/LQilwI4szts.Yc5xBSehHCwICvmxeCOxwbhwSfE5vxAUFvflXO', 'recenzent1', true, true, 'grad', 'drzava', 'title', false, null
WHERE 
NOT EXISTS (
